...
import importlib
from fuzzing_generator import test_llm_generated_code
from search_based import search_based
...
def generate_inital_tests_with_llm(model, function_to_test):
    ...
    print("**********************Tests produced by LLM: ***********************************88")
...
if __name__ == "__main__":
    ...
    for _ in range(5):
        ...
        try:
            ...
            """
            print("************* BEFOREEEEE ***********************************************: ")
            inputs = search_based(function_to_test)
            print("************* AFTERRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRR ***********************************************: ")

            new_inputs_list = inputs # replace this list with the output of your generator
            print("************* NEW INPUTS ***********************************************: ")
            print(new_inputs_list)
            print("************* NEW INPUTS **************************************************: ")
        ...
        score_saved.append(final_score)
